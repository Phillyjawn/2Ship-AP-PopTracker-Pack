...
Tracker:AddLayouts("layouts/checks.jsonc")
Tracker:AddLayouts("layouts/checks_tabs.jsonc")
Tracker:AddLayouts("layouts/day_night.jsonc")
...
Tracker:AddLayouts("layouts/horizontal_misc.jsonc")
Tracker:AddLayouts("layouts/horizontal_remnants.jsonc")
Tracker:AddLayouts("layouts/horizontal_souls.jsonc")
...
Tracker:AddLayouts("layouts/vertical_misc.jsonc")
Tracker:AddLayouts("layouts/vertical_souls.jsonc")